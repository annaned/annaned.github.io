...
function wypisz_haslo(){
    ...
    if (haselko === haslo) {
        document.getElementById("pojemnik2").id = "gratulacje_pojemnik";
        document.getElementById("gratulacje_pojemnik").innerHTML = "<div id=\"zwyciezca\">GRATULACJE<br>ODGADŁEŚ HASŁO</div>";
    }
}
...
function sprawdz(nr){
    ...
    if (trafiona == true) {
        ...
        if (b==9){
            ...
            document.getElementById("alfabet").id="jeszcze_raz";
